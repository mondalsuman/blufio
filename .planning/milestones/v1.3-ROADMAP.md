...
- **v1.3 Ecosystem Expansion** — Phases 29-45 (complete)
...
### v1.3 Ecosystem Expansion (COMPLETE)
...
**Status:** Complete -- all 71 requirements verified, all gap closure phases done, traceability synced.
...
Plans:
- [x] 30-01: OpenAI provider (blufio-openai)
- [x] 30-02: Ollama provider (blufio-ollama)
- [x] 30-03: OpenRouter provider (blufio-openrouter)
- [x] 30-04: Gemini provider (blufio-gemini)
...
Plans:
- [x] 31-01: OpenAI-compatible /v1/chat/completions with wire type separation
- [x] 31-02: OpenResponses /v1/responses API
- [x] 31-03: Tools API (/v1/tools, /v1/tools/invoke)
...
Plans:
- [x] 32-01: Scoped API key management and rate limiting
- [x] 32-02: Webhook registration and event delivery
- [x] 32-03: Batch operations API
...
Plans:
- [x] 37-01: Node pairing and mutual authentication (blufio-node)
- [x] 37-02: Node WebSocket connection, heartbeat, and fleet CLI
- [x] 37-03: Approval routing broadcast
...
Plans:
- [x] 38-01-PLAN.md — OpenClaw migration tool (migrate, preview, config translate)
- [x] 38-02-PLAN.md — CLI utilities (bench, privacy, recipe, uninstall, bundle)
...
Plans:
- [x] 40-01: Global EventBus creation and subsystem sharing in serve.rs
- [x] 40-02: Wire blufio-bridge import and run_bridge_loop() startup
...
Plans:
- [x] 41-01: Add provider crate deps and implement concrete ProviderRegistry
- [x] 41-02: Wire ProviderRegistry into GatewayState in serve.rs
...
Plans:
- [x] 42-01-PLAN.md — Add store/event_bus setters to GatewayChannel, instantiate stores in serve.rs
- [x] 42-02-PLAN.md — Spawn webhook delivery background task with EventBus
...
Plans:
- [x] 44-01-PLAN.md — BusEvent type string mapping + ConnectionManager ApprovalResponse forwarding
- [x] 44-02-PLAN.md — Wire ApprovalRouter creation + EventBus subscription in serve.rs
...
*Last updated: 2026-03-08 after Phase 45 documentation and traceability sync*
